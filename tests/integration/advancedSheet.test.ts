import { testWithNewSheet } from "$tests/fixtures/playwrightFixtures";
import {
...
testWithNewSheet.setTimeout(1000 * 100);

testWithNewSheet("Advanced Sheet Test", async ({ clientA, clientB }) => {
